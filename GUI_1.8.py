...
def writeToFile(summary,name):
    ...
    filename = filedialog.asksaveasfilename(initialdir = "/",title = 'Save Summary',filetypes = (("text files","*.txt"),("all files","*.*")))
    if not filename:
        return
...
def checksent(n):
    if(n.isdigit()):
        if(int(n)>=2):
            ...
            return "sentences should be more than or equal to 2"
    else:
        return "sentences should be a number"
...
def checkwords(n):
    if(n.isdigit()):
        if(int(n)>=100):
            ...
            return "sentences should be more than or equal to 100"
    else:
        return "sentences should be a number"
...
def postvalidate(n):
    if(n.isdigit()):
        if(int(n)<=100):
            ...
            return "posts should be less than or equal to 100"
    else:
...
def saveImg():
    filename = filedialog.asksaveasfilename(initialdir = "/",title = 'Save Word Cloud',filetypes = (("PNG files","*.png"),("all files","*.*")))
    if not filename:
        return
    file = open('word_cloud.png','rb')
    file2 = open(filename+'.png','wb')
    byt = file.read()
    file2.write(byt)
    file.close()
...
def showImage():
    ...
    Top.geometry("{}x{}+{}+{}".format(windowWidth,windowHeight,positionRight, positionDown))
    img = Image.open('word_cloud.png')
    img = img.resize((250, 250), Image.ANTIALIAS) 
    render = ImageTk.PhotoImage(img)
    Labl = LabelFrame(Top, text="Word Cloud",font = ('times new roman',20,'bold','italic'))
    Labl.place(relx=0.05,rely=0.05, relwidth = .9, relheight=0.8)
    Img = Label(Labl,image= render)
    Img.image = render
    Img.pack(fill = "both", expand = "yes")
    
    dowbtn1 = Button(Top, text = "Download",font = ('Arial',11),cursor="hand2",command = lambda: saveImg())
    dowbtn1.place(relx = 0.275,rely = 0.9, relwidth = 0.2, relheight = .075)
    
    closebtn1 = Button(Top, text = "Close",font = ('Arial',11),cursor="hand2",command = lambda: closeWindow(Labl,Top))
    closebtn1.place(relx = 0.525,rely = 0.9, relwidth = 0.2, relheight = .075)
...
def multiprocess(canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5):
    ...
    if CheckVar1.get()==1:
        ...
        dbtn1 = Button(l30, text = "Download",cursor="hand2",activeforeground='white',activebackground='black',font = ('Arial',11),command = lambda: writeToFile(k['text'],"Text file Summarized Text.txt"))
    ...
    if CheckVar2.get()==1:
        ...
        dbtn2 = Button(l30, text = "Download",cursor="hand2",activeforeground='white',activebackground='black',font = ('Arial',11),command = lambda: writeToFile(k['pdf'],"PDF file Summarized Text.txt"))
    ...
    if CheckVar3.get()==1:
        if(var.get()==1):
            ...
            dbtn31 = Button(l30, text = "Download",cursor="hand2",activeforeground='white',activebackground='black',font = ('Arial',11),command = lambda: writeToFile(k['url'],"URL Summarized Text.txt"))
            ...
            dbtn32 = Button(l30, text = "Download",cursor="hand2",activeforeground='white',activebackground='black',font = ('Arial',11),command = lambda: writeToFile(k['url'],"Wikipedia Summarized Text.txt"))
    ...
    if CheckVar4.get()==1:
        if(var1.get()==1):
            ...
            if(var2.get()==1):
                ...
                cbtn41 = Button(l30, text = "Word Cloud",activeforeground='white',activebackground='black',font = ('Arial',11),cursor="hand2",command = lambda: showImage())
                dbtn41 = Button(l30, text = "Download",activeforeground='white',activebackground='black',font = ('Arial',11),cursor="hand2",command = lambda: writeToFile(k['soc'],"Facebook Posts and Twitter Tweets Summarized Text.txt"))
                SumRes.append([sumlab41,vbtn41,dbtn41,cbtn41])
                ...
                cbtn42 = Button(l30, text = "Word Cloud",activeforeground='white',activebackground='black',font = ('Arial',11),cursor="hand2",command = lambda: showImage())
                dbtn42 = Button(l30, text = "Download",cursor="hand2",activeforeground='white',activebackground='black',font = ('Arial',11),command = lambda: writeToFile(k['soc'],"Facebook Posts and Twitter Tweets Summarized Text.txt"))
                SumRes.append([sumlab42,vbtn42,dbtn42,cbtn42])
            ...
            cbtn43 = Button(l30, text = "Word Cloud",activeforeground='white',activebackground='black',font = ('Arial',11),cursor="hand2",command = lambda: showImage())
            dbtn43 = Button(l30, text = "Download",cursor="hand2",activeforeground='white',activebackground='black',font = ('Arial',11),command = lambda: writeToFile(k['soc'],"RSS Feeds Summarized Text.txt"))
            SumRes.append([sumlab43,vbtn43,dbtn43,cbtn43])
    
    proces_labl.place_forget()
    y = .1
    for eles in SumRes:
        eles[0].place(relx=.05,rely = y)
        eles[1].place(relx=.45,rely = y, relwidth = .1)
        eles[2].place(relx=.6,rely = y, relwidth = .15)
        if len(eles)==4:
            eles[3].place(relx=.8,rely = y, relwidth = .15)
        y+=.1
    canvas8.pack_forget()
...
def ExceptBox():
    ...
    Top.geometry("{}x{}+{}+{}".format(windowWidth//3,windowHeight//3,positionRight+windowWidth//3, positionDown+windowHeight//3))
    Labl = Label(Top, text="Connection Error",font = ('times new roman',20,'bold','italic'))
    Labl.place(relx=0.1,rely=0.1)
    
    closebtn1 = Button(Top, text = "Close",font = ('Arial',11),cursor="hand2",command = lambda: closeWindow(Labl,Top))
    closebtn1.place(relx = 0.4,rely = 0.7, relwidth = 0.2, relheight = .2)
...
def nextFunction(canvas,canvas2,textBox1,var,l17):
    ...
    for k in keys:
        try: 
            ...
            if len(wiki_pages)==0:
                wiki_pages = [wikipedia.suggest(k)]
        except:
            ExceptBox()
            return
        if k in wiki_pages:
...
def nextFunction3(canvas3,canvas4,canvas5,canvas6,canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5):
    if(checkfile(E1.get().rstrip())):
        if(checksent(E10.get().rstrip())=="valid"):
            canvas3.pack_forget()  
            if(CheckVar2.get()==1):
                canvas4.pack(fill=BOTH,expand=YES)
            elif(CheckVar3.get()==1):
        ...
        elif(checksent(E10.get().rstrip())=="sentences should be more than or equal to 2"):
            messagebox.showinfo("Invalid entry", "The given number of sentences required in the summary should be greater than or equal to 2!!")
        elif(checksent(E10.get().rstrip())=="sentences should be a number"):
            messagebox.showinfo("Invalid entry", "The given number of sentences required in the summary is invalid!!  It should be an integer.")
    else:
...
def nextFunction4(canvas4,canvas5,canvas6,canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5):
    if(checkfile(E2.get().rstrip())):
        if(checksent(E11.get().rstrip())=="valid"):
            canvas4.pack_forget() 
            if(CheckVar3.get()==1):
                canvas5.pack(fill=BOTH,expand=YES)
            elif(CheckVar4.get()==1):
                ...
                canvas8.pack(fill=BOTH,expand=YES)
                multiprocess(canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5)
        elif(checksent(E11.get().rstrip())=="sentences should be more than or equal to 2"):
            messagebox.showinfo("Invalid entry", "The given number of sentences required in the summary should be greater than or equal to 2!!")
        elif(checksent(E11.get().rstrip())=="sentences should be a number"):
            messagebox.showinfo("Invalid entry", "The given number of sentences required in the summary is invalid!!  It should be an integer.")
    else:
        messagebox.showinfo("File error", "The given file path does not exist!!")
    ...
    if(var.get()==1):
        ...
        if(m=="String is a valid URL"):
            if(depthvalidate(E4.get().rstrip())=="valid"):
                if(checkwords(E5.get().rstrip())=="valid"):
                    canvas5.pack_forget()
                    if(CheckVar4.get()==1):
                        canvas6.pack(fill=BOTH,expand=YES)
                    else:
                        canvas8.pack(fill=BOTH,expand=YES)
                        multiprocess(canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5)
                elif(checkwords(E5.get().rstrip())=="sentences should be more than or equal to 100"):
                    messagebox.showinfo("Invalid entry", "The given number of words required in the summary should be greater than or equal to 100!!")
                elif(checkwords(E5.get().rstrip())=="sentences should be a number"):
                    messagebox.showinfo("Invalid entry", "The given number of words required in the summary is invalid!!  It should be an integer.")
        ...
        if(checkwords(E6.get().rstrip())=="valid"):
            canvas5.pack_forget()
            if(CheckVar4.get()==1):
                canvas6.pack(fill=BOTH,expand=YES)
            else:
                canvas8.pack(fill=BOTH,expand=YES)
                multiprocess(canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5)
        elif(checkwords(E6.get().rstrip())=="sentences should be more than or equal to 100"):
            messagebox.showinfo("Invalid entry", "The given number of words required in the summary should be greater than or equal to 100!!")
        elif(checkwords(E6.get().rstrip())=="sentences should be a number"):
            messagebox.showinfo("Invalid entry", "The given number of words required in the summary is invalid!!  It should be an integer.")
...
def nextFunction6(canvas6,canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5):
    if(var1.get()==1):
        if(postvalidate(E8.get().rstrip())=="valid"):
            canvas6.pack_forget()
            canvas8.pack(fill=BOTH, expand=YES)
            multiprocess(canvas7,canvas8,CheckVar1,CheckVar2,CheckVar3,CheckVar4,SumRes,E1,E2,E10,E11,E3,var,textBox1,var1,textBox8,E8,cal,E7,E9,var2,key,E6,E4,E5)
        elif(postvalidate(E8.get().rstrip())=="posts should be less than or equal to 100"):
            messagebox.showinfo("Invalid entry", "The number of facebook posts or tweets required for the data extraction should be less than or equal to 100.")
        elif(postvalidate(E8.get().rstrip())=="posts should be a number"):
            messagebox.showinfo("Invalid entry", "The given number of facebook posts or tweets required for the data extraction is invalid!!  It should be an integer.")
    elif(var1.get()==2):
